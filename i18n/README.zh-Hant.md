...
> **版本說明：**附時間戳的轉錄由機器產生，可能含有辨識錯誤。已編譯書籍是依據轉錄與黑板畫面重建、經獨立編輯並由 AI 輔助整理的配套筆記；它們不是逐字稿、Susskind 教授的原始手稿，也不是經其認可的版本。正在進行的[編輯修訂](../references/editorial_revision_status.md)會逐章記錄文字來源與圖片依據。
