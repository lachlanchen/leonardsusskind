...
\begin{figure}[h]
\centering
\includegraphics[width=0.94\textwidth]{lecture_02_frame_01.png}
\caption{Prototype symmetry motifs: geometric and discrete transformations that can commute with the Hamiltonian.}
\end{figure}
...
\end{aligned}
\]
Hence \(\mathcal M\) and \(L_z\) together generate two operations whose noncommutativity forces additional structure.
