...
\end{equation}
\editorialnote{At lecture timestamp 00:05:30 the board clearly shows the kinetic term and the density-dependent potential term. The full coefficient written here follows from the spoken derivation.}
...
\editorialnote{At lecture timestamp 00:44:45 the board shows only the axes at the start of the comparison plot. The matter and radiation curves discussed immediately afterward are described in the text rather than redrawn here.}
