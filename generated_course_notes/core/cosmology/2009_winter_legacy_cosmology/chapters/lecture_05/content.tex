...
\node at (0,-2.75) {Poincar\'e disk: equal objects shrink toward the boundary};
\end{tikzpicture}
}%
\caption{A schematic disk picture for negative curvature. The boundary looks finite in the drawing, but its intrinsic distance is infinite.}
\end{figure}
