...
\end{tikzpicture}
\caption{Explanatory redraw of the circle-universe spacetime for three choices of scale factor. These are external visualization aids that follow the lecture's narrative; they do not replace the intrinsic metric description.}
\end{figure}
