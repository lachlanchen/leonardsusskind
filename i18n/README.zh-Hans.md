...
> **版本说明：**带时间戳的转录由机器生成，可能含有识别错误。已编译书籍是根据转录和黑板画面重建、经独立编辑并由 AI 辅助整理的配套笔记；它们不是逐字稿、Susskind 教授的原始手稿，也不是经其认可的版本。正在进行的[编辑修订](../references/editorial_revision_status.md)会逐章记录文字来源与图片依据。
