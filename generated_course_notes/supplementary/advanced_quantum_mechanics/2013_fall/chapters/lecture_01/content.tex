...
\begin{equation}
\ket\phi\text{ and }\ket\psi\text{ are distinguishable with certainty } \Longleftrightarrow \langle\phi|\psi\rangle=0.
\end{equation}
...
H=\frac{\hat p_x^2}{2m},
\end{equation}
and \([H,\hat p_x]=0\), so translation is a symmetry and \(\hat p_x\) is conserved. Thus the same operator appears as both “generator of translations” and “conserved quantity,” illustrating the lecture’s central symmetry--conservation link.
