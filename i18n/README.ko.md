...
> **판본 안내:** 타임스탬프가 있는 전사문은 기계 생성 자료이므로 인식 오류가 있을 수 있습니다. 완성 PDF는 전사문과 칠판 화면을 바탕으로 독립적으로 편집한 AI 보조 동반 노트이며, 정확한 축어록이나 Susskind 교수의 원고 또는 승인 판본이 아닙니다. 진행 중인 [편집 개정](../references/editorial_revision_status.md)은 각 장의 출처와 그림 근거를 기록합니다.
