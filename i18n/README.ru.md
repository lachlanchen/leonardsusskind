...
> **Примечание об издании:** расшифровки с временными метками созданы автоматически и могут содержать ошибки распознавания. Скомпилированные книги — независимо отредактированные, подготовленные с помощью ИИ сопроводительные заметки, реконструированные по расшифровкам и кадрам доски; это не дословные стенограммы, не оригинальные рукописи и не одобренные Леонардом Сасскиндом издания. Текущая [редакционная переработка](../references/editorial_revision_status.md) фиксирует источники и происхождение иллюстраций для каждой главы.
