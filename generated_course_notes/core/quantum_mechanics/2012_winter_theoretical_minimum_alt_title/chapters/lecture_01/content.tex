...
-1\to -1\to -1\to \cdots.
\end{equation}
Thus the measurement is not merely a readout. It is also a preparation.
Once the qubit has been found in a given state, repeating the same experiment leaves that result fixed.
...
\end{equation}
This is not because the apparatus is secretly returning intermediate values.
It never does.
The average is zero only because, over many identically prepared trials, there are as many \(+1\)'s as \(-1\)'s.
