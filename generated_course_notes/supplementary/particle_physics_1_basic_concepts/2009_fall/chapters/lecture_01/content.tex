...
\begin{equation}
\beta\text{-radiation}=\text{electrons},\qquad
\alpha\text{-radiation}=\text{helium nuclei},\qquad
\gamma\text{-radiation}=\text{photons}.
\end{equation}
But the lecture does not move too quickly. Before telling us what these branches are, it pauses over what was actually learned. Whatever was coming out of the source behaved as if it came in distinguishable components, and if the source were dilute enough one could imagine the screen registering arrivals one at a time: blip, blip, blip. Alpha arrives in little bundles. Beta arrives in little bundles. Gamma too arrives in little bundles.
